...
const AdminDashboardView = () => {
  ...
  useEffect(() => {
    axios.get('https://ihrdigitalpartner.herokuapp.com/api/users/get-all').then((response) => {
  ...
  const handleAdd = () => {
    axios
      .post('https://ihrdigitalpartner.herokuapp.com/api/users/add', {
        firstName: firstName,
        lastName: lastName,
        street: street,
        birthday: birthday,
  ...
  const handleUpdate = () => {
    axios
      .post('https://ihrdigitalpartner.herokuapp.com/api/users/update', {
  ...
  const handleDelete = (user) => {
    axios
      .post('https://ihrdigitalpartner.herokuapp.com/api/users/delete', {
